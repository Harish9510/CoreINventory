    ...
    return Scaffold(
      ...
      body: Consumer<InventoryStore>(
        builder: (context, store, _) {
          final deliveries = store.getOperationsByType(OperationType.delivery);
          return deliveries.isEmpty
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (_, i) => _opCard(context, store, deliveries[i]),
                );
        },
      ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Track outgoing stock and customer shipments',
            style: GoogleFonts.inter(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _infoRow(Iconsax.user, 'Customer: ${op.partner ?? "Walk-in"}'),
